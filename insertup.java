...
public class insertup extends JFrame {
	...
	public insertup() {
		...
		btnInsert.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					String query = " insert into vehicle(policy_id,name,mobile_no,vtype,vehicle_no,rc_no,purchase_date,location,pcommence,pexpiry)"
							+ " values (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
		...
		lblNewLabel_1.setIcon(new ImageIcon(
				"C:\\Users\\dell\\Desktop\\project\\1682699-inline-slide-13-a-brief-cultural-history-of-the-volkswagen-beetle.jpg"));
